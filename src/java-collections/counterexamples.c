...
heap->dist[3] = 0;
// set universals
heap->universal[0][0] = 2;
heap->universal[1][0] = 0;
heap->universal[2][0] = 0;
heap->universal[3][0] = 0;
// set existantials
heap->existential[0][0] = 2;
heap->existential[1][0] = 0;
heap->existential[2][0] = 0;
heap->existential[3][0] = 0;
heap->nnodes = 3 ;
}
